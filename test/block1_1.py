...
def main(args=None):
    ...
    System_first_block = posx([249.49, -147.54, 340.00, 163.97, -179.72, 165.02])
    System_second_block = posx([353.89, 152.21, 340.00, 23.53, -179.61, 24.84])
    ...
    while rclpy.ok():
        ...
        while cnt < 10:
            ...
            a = cnt // 3 * 50
            b = cnt % 3 * -50
            pos = posx(p1[0] + a, p1[1] + b)
            pos2 = posx(p2[0] + a, p1[1] + b)
            cnt += 1
